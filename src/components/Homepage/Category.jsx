...
const categories = [
  {
    ...
    image: "https://images.unsplash.com/photo-1598440448730-bd341396fa61?auto=format&fit=crop&q=80&w=1000",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1527799822340-47405d10bc36?auto=format&fit=crop&q=80&w=800",
    gridClass: "md:col-span-6 md:row-span-1",
  }
];
...
const CategoryCard = ({ category, index }) => {
  ...
  return (
    <div 
      ref={cardRef}
      className={`relative overflow-hidden group cursor-pointer ${category.gridClass} transition-all duration-1000 ease-out rounded-[60px] ${
