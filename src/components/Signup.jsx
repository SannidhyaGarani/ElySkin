  ...
  return (
    <div className="min-h-screen bg-[#FFF9F1] flex items-center justify-center px-6 py-32 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-[#FF6B00]/5 rounded-full blur-[120px]" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-[#0A2D50]/5 rounded-full blur-[120px]" />
      </div>
      ...
      <div className="w-full max-w-xl bg-white rounded-[48px] border border-[#0A2D50]/5 shadow-[0_40px_100px_rgba(10,45,80,0.08)] p-8 md:p-16 relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-[#0A2D50] tracking-tighter mb-4">
            Begin Your <span className="text-[#FF6B00]">Ritual</span>
          </h2>
          <p className="text-[#0A2D50]/60 font-medium">Join our world of clinical precision and care.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-widest text-[#0A2D50]/40 ml-4">Full Name</label>
            <div className="relative">
              <User className="absolute left-6 top-1/2 -translate-y-1/2 text-[#0A2D50]/20" size={20} />
              <input
                type="text"
                value={displayName}
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-widest text-[#0A2D50]/40 ml-4">Password</label>
            <div className="relative">
          ...
          <div className="flex items-start gap-3 px-2 py-4">
            ...
            <p className="text-[10px] text-[#0A2D50]/40 font-bold leading-relaxed">
              By creating an account, you agree to our <span className="text-[#0A2D50]">Terms of Service</span> and <span className="text-[#0A2D50]">Privacy Policy</span>.
            </p>
          </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-[#0A2D50]/60 font-medium">
            ...
            <Link to="/login" className="text-[#FF6B00] font-black hover:underline ml-1">
              Sign In
            </Link>
          </p>
        </div>
