    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        <button
          type="submit"
          disabled={loading}
          className="px-4 py-2 rounded-lg bg-[#811331] text-white font-medium disabled:opacity-60"
        >
          {loading ? "Saving..." : "Create"}
        </button>
        {formState.isSubmitted && !loading && !error && <span className="text-sm text-emerald-600">Saved</span>}
